...
#define DC_PIN 0x10 // pin 3
#define RESET_PIN 0x1 // pin 63
#define OLEDCS_PIN 0x2 // pin 64

void writeCommand(unsigned char c) {

    unsigned char receiveDummy;
    GPIOPinWrite(GPIOA1_BASE, DC_PIN, 0x0); // write DC low
    GPIOPinWrite(GPIOA1_BASE, OLEDCS_PIN, 0); // write OLEDCS low
    MAP_SPITransfer(GSPI_BASE,&c,&receiveDummy,1,
...
void writeData(unsigned char c) {
    ...
    unsigned char receiveDummy;
    GPIOPinWrite(GPIOA1_BASE, DC_PIN, DC_PIN); // write DC high
    GPIOPinWrite(GPIOA1_BASE, OLEDCS_PIN, 0x0); // write OLEDCS low
    MAP_SPITransfer(GSPI_BASE,&c,&receiveDummy,1,
            SPI_CS_ENABLE|SPI_CS_DISABLE);
    GPIOPinWrite(GPIOA1_BASE, OLEDCS_PIN, OLEDCS_PIN); // write OLEDCS high
}
...
*/
  ...
  GPIOPinWrite(GPIOA1_BASE, RESET_PIN, 0xFF);	// RESET = RESET_HIGH
